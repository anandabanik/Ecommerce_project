    ...
    <div class="col-md-12">
        <div class="ibox">
            ...
            <div class="ibox-body">
                ...
                <?php endif; ?>
                <form class="form-horizontal" action="<?php echo e(route('category.new')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\ecom\resources\views/admin/category/add.blade.php ENDPATH**/ ?>