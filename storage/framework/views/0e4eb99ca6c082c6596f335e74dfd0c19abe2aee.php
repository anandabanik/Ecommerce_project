<nav class="page-sidebar" id="sidebar">
    <div id="sidebar-collapse">
        <div class="admin-block d-flex">
            <div>
                <img src="<?php echo e(asset('/admin')); ?>/assets/img/admin-avatar.png" width="45px" />
            </div>
        ...
        <ul class="side-menu metismenu">
            ...
            <li>
                ...
                <ul class="nav-2-level collapse">
                    <li>
                        <a href="<?php echo e(route('category.add')); ?>">Add Category</a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('category.manage')); ?>">Manage Category</a>
                    </li>
                </ul>
            </li>
            <li>
                ...
                <ul class="nav-2-level collapse">
                    <li>
                        <a href="<?php echo e(route('subcategory.add')); ?>">Add Sub Category</a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('subcategory.manage')); ?>">Manage Sub Category</a>
                    </li>
                </ul>
            </li>
            <li>
                ...
                <ul class="nav-2-level collapse">
                    <li>
                        <a href="<?php echo e(route('brand.add')); ?>">Add Brand</a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('brand.manage')); ?>">Manage Brand</a>
                    </li>
                </ul>
            </li>
            <li>
                ...
                <ul class="nav-2-level collapse">
                    <li>
                        <a href="<?php echo e(route('unit.add')); ?>">Add Unit</a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('unit.manage')); ?>">Manage Unit</a>
                    </li>
                </ul>
            </li>
            <li>
                ...
                <ul class="nav-2-level collapse">
                    <li>
                        <a href="<?php echo e(route('product.add')); ?>">Add Product</a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('product.manage')); ?>">Manage Product</a>
                    </li>
                </ul>
            </li>
            <li>
...
</nav><?php /**PATH C:\xampp\htdocs\ecomfinal616\ecom\resources\views/admin/includes/menu.blade.php ENDPATH**/ ?>